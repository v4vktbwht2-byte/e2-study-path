...
| CI/deploy        | Complete | remote CI + Pages + live PWA         | Public repository、master CI、Pages deploy、320px実URL・PWA成果物を確認済み |
...
- master coverage CIで顕在化したレッスン再開見出しのfocus effect競合を、focus完了まで待つテストへ修正した。対象テスト10回連続と全75ファイル・551/551件のcoverageをPassした。
